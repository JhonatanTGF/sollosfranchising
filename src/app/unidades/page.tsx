  ...
  return (
    <div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            ...
            <p className="text-xl mb-8">
              ...
              Brasil e encontre a mais próxima de você.
            </p>
          </div>
        </div>
      </section>
      ...
      <Section bgColor="white">
        ...
        <div className="text-center">
          <p className="mb-6">
            A franquia Sniper está em constante expansão, com unidades
            em diversas cidades do Brasil. Encontre a unidade mais
            próxima de você e venha viver essa experiência única!
          </p>
      ...
      <Section bgColor="light">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="card">
              <h4 className="text-xl font-bold mb-2">
                Piracicaba - Piracicaba Shopping
              </h4>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <h3 className="text-2xl font-bold mb-4 text-white">
              EM BREVE EM NOVAS CIDADES
            </h3>
            <p className="mb-6 text-white">
              A franquia Sniper está em constante expansão, com novas
              unidades sendo implantadas em diversas cidades do
              Brasil. Fique atento às novidades e seja o primeiro a
      ...
      <Section bgColor="accent">
        <div className="text-center">
          <h2 className="mb-6">
            NÃO TEM UMA UNIDADE NA SUA{" "}
            <span className="text-white">CIDADE?</span>
          </h2>
          <p className="text-xl max-w-3xl mx-auto mb-8">
            Seja o pioneiro! Traga a franquia Sniper para sua cidade e
            ofereça uma experiência única de entretenimento.
          </p>
          <Button href="/seja-franqueado" variant="primary">
