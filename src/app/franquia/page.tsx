    ...
    <div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mb-6">
              FRANQUIA <span className="text-[#446EEC]">SNIPER</span>
            </h1>
            <p className="text-xl mb-8">
              A maior rede de franquias de entretenimento com estandes
              de tiro de airsoft do Brasil.
            </p>
      ...
      <Section bgColor="white">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="mb-6">
              SOBRE A <span className="text-[#446EEC]">FRANQUIA</span>
            </h2>
            <p className="mb-4">
              A Sniper é uma franquia inovadora no setor de
              entretenimento, oferecendo uma experiência única com
              estandes de tiro de airsoft em um ambiente seguro e
              controlado.
            </p>
            <p className="mb-4">
              Nosso conceito combina diversão, adrenalina e
              competição, atraindo um público diversificado e
              proporcionando momentos inesquecíveis para pessoas de
              todas as idades.
            </p>
            <p className="mb-4">
              Com um modelo de negócio comprovado e alta
              rentabilidade, a franquia Sniper representa uma
              excelente oportunidade de investimento para
              empreendedores que buscam um negócio diferenciado e
              lucrativo.
            </p>
          </div>
      ...
      <Section bgColor="black">
        <h2 className="text-center mb-12 text-white">
          NOSSOS <span className="text-[#446EEC]">DIFERENCIAIS</span>
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-[#111] p-6 text-white">
            <div className="text-[#446EEC] text-4xl mb-4">01</div>
            <h3 className="text-xl font-bold mb-2">
              CONCEITO INOVADOR
            </h3>
            <p>
              Um modelo de negócio único no mercado, combinando
              entretenimento, esporte e adrenalina em um ambiente
              seguro.
            </p>
          </div>
          <div className="bg-[#111] p-6 text-white">
            <div className="text-[#446EEC] text-4xl mb-4">02</div>
            <h3 className="text-xl font-bold mb-2">
              ALTA RENTABILIDADE
            </h3>
            <p>
          ...
          <div className="bg-[#111] p-6 text-white">
            <div className="text-[#446EEC] text-4xl mb-4">03</div>
            <h3 className="text-xl font-bold mb-2">
              SUPORTE COMPLETO
            </h3>
            <p>
          ...
          <div className="bg-[#111] p-6 text-white">
            <div className="text-[#446EEC] text-4xl mb-4">04</div>
            <h3 className="text-xl font-bold mb-2">
              MARCA RECONHECIDA
            </h3>
            <p>
      ...
      <Section bgColor="white">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h2 className="mb-6">
              PÚBLICO-<span className="text-[#446EEC]">ALVO</span>
            </h2>
            <p className="mb-4">
              A franquia Sniper atende um público diversificado,
              atraindo pessoas de diferentes idades e perfis que
              buscam uma experiência de entretenimento diferenciada.
            </p>
            <ul className="space-y-2 mb-6">
              <li className="flex items-start">
                <span className="text-[#446EEC] mr-2">✓</span>
                <span>
                  Jovens e adultos em busca de diversão e adrenalina
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-[#446EEC] mr-2">✓</span>
              ...
              <li className="flex items-start">
                <span className="text-[#446EEC] mr-2">✓</span>
                <span>
                  Empresas para eventos corporativos e team building
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-[#446EEC] mr-2">✓</span>
            ...
            <p>
              Com múltiplas modalidades e níveis de dificuldade, a
              Sniper oferece opções para iniciantes e experientes,
              garantindo diversão para todos os públicos.
            </p>
          </div>
        </div>
      </Section>
      ...
      <Section bgColor="accent">
        <div className="text-center">
          <h2 className="mb-6">
            PRONTO PARA <span className="text-white">INVESTIR?</span>
          </h2>
          <p className="text-xl max-w-3xl mx-auto mb-8">
            Junte-se à maior rede de franquias de entretenimento com
            estandes de tiro de airsoft do Brasil e comece a
            empreender em um negócio inovador e lucrativo.
          </p>
